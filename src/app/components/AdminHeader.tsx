...
import { Menu, X, Home, UserPlus, UserMinus, Briefcase, Eye, LogOut, UserCircle, User } from 'lucide-react';
...
const AdminHeader = ({ onToggleSidebar, sidebarOpen }: AdminHeaderProps = {}) => {
  ...
  const navLinks = [
    { href: '/admin-recruiter/add', label: 'Add Recruiter', icon: UserPlus },
    { href: '/admin-recruiter/remove', label: 'Remove Recruiter', icon: UserMinus },
        ...
        <div className="relative flex items-center h-16">
          ...
          <div className="flex-shrink-0">
            ...
            >
              ...
              <span className="text-xl font-bold tracking-tight">HRXpert Admin</span>
            </Link>
          </div>
